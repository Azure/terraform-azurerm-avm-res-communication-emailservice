...
Module to deploy Email Communication Service in Azure.
...
Description:   A map of role assignments to create on the Email Communication Service. The map key is deliberately arbitrary to avoid issues where map keys maybe unknown at plan time.
